...
import type { Booking as _Booking, BookingStatus as _BookingStatus, Time as _Time, TimeWindow as _TimeWindow, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createBooking(arg0: string | null, arg1: string, arg2: string, arg3: TimeWindow, arg4: string, arg5: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createBooking(to_candid_opt_n3(this._uploadFile, this._downloadFile, arg0), arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBookingDetails(arg0: bigint): Promise<Booking> {
        if (this.processError) {
            try {
                const result = await this.actor.getBookingDetails(arg0);
    ...
    async rescheduleBooking(arg0: bigint, arg1: TimeWindow): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.rescheduleBooking(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "cancelled" in value ? BookingStatus.cancelled : "pending" in value ? BookingStatus.pending : value;
}
